#!/usr/bin/env bash
# Secure file permissions for HK-NOVA
...
chmod 600 hk-nova.db 2>/dev/null || echo "Note: Database file not found or already secured"
...
ls -la .env hk-nova.db 2>/dev/null || true
ls -ld backups/
